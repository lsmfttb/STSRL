...
| T098 | READY | [T096 Public-Information Fidelity Re-entry](T098-t096-public-information-fidelity-reentry.md) | T096, T097 | focused re-entry of the T096 native visibility/fidelity blocker; ordinary regression, supported draw knowledge, Frozen Eye, supported Runic Dome, and intentional fail-closed checks only |
