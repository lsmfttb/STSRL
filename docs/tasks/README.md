...
| T099 | READY | [Native Particle-Search Bridge Source Acceptance](T099-native-particle-search-bridge-source-acceptance.md) | T017, T020, T096, T097, T098 | exact native pin `97f59b6`; old pin and reviewed PR #20 lineage proof; clean canonical verifier; native particle-to-Search bridge, duplicate-occurrence equivalence mapping, mixed information-regime and fail-closed capability acceptance; no convergence or aggregation |
