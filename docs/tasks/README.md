...
| T090 | DONE | [Search-v2 Action-Utility Battle Student](T090-search-v2-action-utility-battle-student.md) | T033, T062, T078, T081, T085, T087, T088 | PR #104 accepted; exact 413-start target generation and provenance validated, but raw eligibility was 309/6,210 (4.9758%), below the frozen 95% gate; terminal classification `BATTLE_STUDENT_TARGET_COVERAGE_INSUFFICIENT`, so training/held-out and student promotion were not run |
| T091 | DONE | [Battle Teacher Data-Surface Density Audit](T091-battle-teacher-data-surface-density-audit.md) | T011, T016, T025, T062, T078, T081, T087, T088, T090 | PR #105 validates the exact retained T090 formal evidence and reproduces S0 = 309/6,210. At `n_min=4`, 4,074 roots and 49,378 ordered non-tie pairs are exposed, but the preregistered root partial-supervision gate fails (65.60% < 70% pair-supported roots, median supported/legal fraction 0.25 < 0.40, and high-frequency potion kinds have no pair participation); terminal classification `ROOT_PARTIAL_SUPERVISION_TOO_SPARSE_OR_BIASED`. The bounded static audit records `CURRENT_SEARCH_INTERNAL_SURFACE_FEASIBLE`; no student, Search change, simulator run, or internal-state export was performed. |
...
| T097 | DONE | [Native Visibility Capability Source Acceptance](T097-native-visibility-capability-source-acceptance.md) | T017, T020, T096 | exact native pin `d309170`; old pin and reviewed PR #18 lineage proved; clean canonical verifier, API smoke, deterministic visibility audit, and focused T096 smoke passed; terminal `NATIVE_PUBLIC_INFORMATION_CAPABILITY_ACCEPTED`; no scientific T096 rerun or downstream promotion |
| T098 | DONE | [T096 Public-Information Fidelity Re-entry](T098-t096-public-information-fidelity-reentry.md) | T096, T097 | exact native pin `d309170`; bounded N=32 ordinary, Headbutt known-top, Frozen Eye, and supported Runic Dome witnesses passed full public/legal parity, diversity where required, and intentional timing-mixed fail-closed; terminal `PUBLIC_HIDDEN_FUTURE_SAMPLER_FIDELITY_READY`; no convergence, Search, training, controller promotion, or T034 closure |
| T099 | DONE | [Native Particle-Search Bridge Source Acceptance](T099-native-particle-search-bridge-source-acceptance.md) | T017, T020, T096, T097, T098 | exact native pin `97f59b6`; old pin and reviewed PR #20 head are proved ancestors and active `stsrl/main` resolves exactly; clean 16-worker canonical verifier, STSRL-006 audit, bounded bridge, occurrence-equivalence mapping, T096/T098 visibility/sampler, Frozen Eye/known-draw, and Search-v2 compatibility checks passed; terminal `NATIVE_PARTICLE_SEARCH_BRIDGE_CAPABILITY_ACCEPTED`; no convergence, aggregation/action selection, Search change, training, controller, T034, Non-Combat, or T066 work |\n| T100 | READY | [Repository Information-Architecture Compaction](T100-repository-information-architecture-compaction.md) | T099, current collaboration/documentation governance | compact current-state and task-navigation surfaces; preserve Planner Dashboard/#85 low-friction roles; separate merge-stable repository state from transient PR lifecycle state; no scientific/runtime changes; T101 remains the bounded particle-count convergence successor |
