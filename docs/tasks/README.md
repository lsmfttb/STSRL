...
| T094 | READY | [A-Cohort Supervision Attrition Decision Audit](T094-a-cohort-supervision-attrition-decision-audit.md) | T052, T085, T087, T090, T092, T093 | Lightweight offline exact-artifact audit locating where source-group A loses independent-start supervision across pre-dedup `n_min=1/2/4`, cross-split exclusion, and final T093 canonicalization, with B/C controls; chooses among low-supervision stress-distribution, visit-support, or dataset-canonicalization successor routes; no Search rerun, student training, controller integration, Non-Combat update, or T066. |
