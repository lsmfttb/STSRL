...
| T102 | READY | [Planner Rendezvous, Review Notification, and Maintainer Resume Protocol](T102-agent-planner-notification-protocol.md) | T100, T101, current governance | governance-only; nonce/assertion Planner discovery, durable-first direct request, Maintainer heartbeat/poll resume, handoff supersession, notification-not-authority |
