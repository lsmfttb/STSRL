...
| T081 | DONE | [Scientific artifact eligibility gate](T081-scientific-artifact-eligibility-gate.md) | T043, T044, T047, T048, T051, T052, T054, T055, T064, T065, T070, T075, T077 | central forward-evidence eligibility enforcement |
| T082 | DONE | [Lineage-safe current-status compaction](T082-lineage-safe-current-status-compaction.md) | T081 | latest-lineage current state and history archive |
| T083 | DONE | [Natural late-game source bootstrap](T083-natural-late-game-source-bootstrap.md) | T082, T081, T050, T040, T039, T016 | `INSUFFICIENT_NATURAL_LATE_GAME_COVERAGE` |
| T084 | DONE | [Bounded natural late-game source acquisition](T084-bounded-natural-late-game-source-acquisition.md) | T083, T082, T081, T050, T040 | `BOUNDED_NATURAL_ACQUISITION_INSUFFICIENT` |
| T085 | DONE | [Normal-information late-game support audit](T085-normal-information-late-game-support-audit.md) | T084, T083, T081, T016, T033, T040 | historical source identity `d62ea81`; diagnostic coverage only, no Q-public semantics |
| T086 | — | no published task | — | numbering gap retained for provenance |
| T087 | DONE | [Normal-information fixed-cohort decision diagnostic](T087-normal-information-fixed-cohort-diagnostic.md) | T085, T081, T016, T033, T062, T078, T084 | `NORMAL_INFORMATION_DECISION_DIAGNOSTIC_COMPLETE` |
| T088 | DONE | [Search-Budget Stability And Action-Ranking Diagnostic](T088-search-budget-stability-and-action-ranking.md) | T087, T085, T081, T062, T079 | `SEARCH_BUDGET_STABILITY_DIAGNOSTIC_COMPLETE` |
| T089 | DONE | [Paired Hidden-Information Action-Value Gap Diagnostic](T089-paired-hidden-information-action-value-gap.md) | T087, T088, T085, T081, T062, T079 | `PAIRED_HIDDEN_INFORMATION_ACTION_VALUE_GAP_COMPLETE` |
| T090 | DONE | [Public-Information Action-Value Semantics Contract](T090-public-information-action-value-semantics-contract.md) | T089, T087, T088, T085, T081, T062, T079 | `PUBLIC_INFORMATION_ACTION_VALUE_SEMANTICS_CONTRACTED` |
| T091 | DONE | [Normal-Information Particle Approximation Feasibility Diagnostic](T091-normal-information-particle-approximation-feasibility.md) | T090, T089, T087, T088, T085, T081, T062, T079 | `NORMAL_INFORMATION_PARTICLE_APPROXIMATION_FEASIBLE`; strategy-fusion proxy only |
| T092 | DONE | [Normal-Information Particle Proxy Fidelity And Cost Diagnostic](T092-normal-information-particle-proxy-fidelity-and-cost.md) | T091, T090, T089, T087, T088, T085, T081, T062, T079 | `NORMAL_INFORMATION_PARTICLE_PROXY_FIDELITY_COST_DIAGNOSTIC_COMPLETE`; strategy-fusion proxy only |
| T093 | CANCELLED | [Frozen Strategy-Fusion Proxy Contract](T093-frozen-strategy-fusion-proxy-contract.md) | T092, T091, T090, T089, T087, T088, T085, T081, T062, T079 | cancelled pre-implementation after semantic defect; no forward evidence |
| T094 | DONE | [Deterministic Information-State Keying Audit](T094-deterministic-information-state-keying-audit.md) | T090, T091, T092, T093, T016, T033, T085 | `INFORMATION_STATE_KEYING_CONTRACT_AUDITED` |
...
| T102 | READY | [Metadata-Current Planner Routing and Maintainer Polling Protocol](T102-agent-planner-notification-protocol.md) | T100, T101, current governance | governance-only; metadata-only current Planner selection, durable PR response, active-turn polling, recoverable idempotent resume |
