...
def run_lightspeed_command(args: argparse.Namespace) -> int:
    ...
    try:
        ...
        if args.lightspeed_smoke:
            ...
            if not report.evaluation_successful:
                return 1
        elif args.lightspeed_t054_guardrailed_root_prior_repair_comparison is not None:
            budget = (
                args.oracle_search_simulations
                if args.search_budget is None
                else args.search_budget
            ...
            report = run_root_prior_guided_search_comparison_from_cohort_path(
                ...
                cohort_path=(
                    args.lightspeed_t054_guardrailed_root_prior_repair_comparison
                ),
                controller_arms=(
                    (
                        BASELINE_ORACLE_LABEL,
                ...
                action_space=action_space,
                max_battle_steps=args.sim_steps,
                run_scale=args.t054_guardrailed_root_prior_repair_scale,
